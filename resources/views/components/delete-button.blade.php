<form action="{{ $action }}" method="POST" onsubmit="return confirm('Czy na pewno chcesz usunąć tę jednostkę?');">
  @csrf
  @method('DELETE')

  <button type="submit" class="rounded-lg p-0 hover:bg-red-800 inline-flex items-center justify-center mb-4">
